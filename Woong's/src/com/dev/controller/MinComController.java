...
public class MinComController implements Controller {
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		
		int mincpu = Integer.parseInt(request.getParameter("mincpu"));
		int minram = Integer.parseInt(request.getParameter("minram"));
		int mingpu = Integer.parseInt(request.getParameter("mingpu"));
		...
		ArrayList<ComputerVO> list_cpu = service.mincpu(gm);
		ArrayList<ComputerVO> list_ram = service.minram(gm);
		ArrayList<ComputerVO> list_gpu = service.mingpu(gm);
		...
		HttpUtil.forward(request, response, "min_computer.jsp");
	}
