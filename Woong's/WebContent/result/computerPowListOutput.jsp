        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="page-heading">
              <h1>Product</h1>
              <span class="subheading">POWER List</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <h1>POWER</h1>
 					...
 					<table border="3">
   					...
   					<% for (int i=0;i<list.size();i++){
   						ComputerVO pow = list.get(i); %>
   						<tr style="background-color:#F1F1F3">
   						<td><a href="#"><img src='<%=pow.getJino_pow_img()%>'></a></td>
   						<td class="Gname"><%=pow.getJino_pow_name() %></td>
   						<td class="Gprice"><%=pow.getJino_pow_price() %>원</td></tr>
   					<%	}
   					}else{
