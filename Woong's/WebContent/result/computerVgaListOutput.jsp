        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="page-heading">
              <h1>Product</h1>
              <span class="subheading">VGA List</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-100% col-md-100 mx-auto">
          ...
          <h1>VGA</h1>
   					...
   					if(!list.isEmpty()) {%>
 					<table border="3">
   					<thead><tr><th>이미지</th><th>그래픽카드 이름</th><th>가격</th></tr></thead>
   					<% for (int i=0;i<list.size();i++){
   						ComputerVO vga = list.get(i); %>
   						<tr style="background-color:#F1F1F3">
   						<td><a href="#"><img src='<%=vga.getJino_vga_img2()%>'></a></td>
   						<td class="Gname"><%=vga.getJino_vga_name() %></td>
   						<td class="Gprice"><%=vga.getJino_vga_price() %>원</td></tr>
   					<%	}
   					}else{
